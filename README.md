...
**1) write code with more modularity 2) practice writing code with testing in mind 3) naming files and variables that represents functionality and is easily recognisable**
